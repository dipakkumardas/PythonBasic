...
# {}
lis = [1, 2, 3, 4, 5, 1]
my_set = set(lis)        # It will Removed te duplicate item from the list
print(my_set)
...
non_empty_set = set("Dipak")  # D i p a k
print(non_empty_set)

# Creating a Set with
# the use of a List
set1 = set(["Dipak", "David", "Peter"])
print(set1)
...
# Pop is removing arbetery element

set10 = {"Dipak","Lucky","Amit","David","AA"}
#set10.pop()
#print(set10)
set10.remove("Dipak")
print(set10)
